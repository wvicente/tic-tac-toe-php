...
class TicTacToe {
	...
	public const NORMAL = 3; // not too deep
...
$result = $ttt
	->set_difficulty(TicTacToe::HARD)
	->set_Players(TicTacToe::X)
	->set_board($board)
	->Play();
	// ->minimax($board, false);

// print_r($minmax_result);
